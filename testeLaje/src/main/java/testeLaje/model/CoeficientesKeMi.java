...
public class CoeficientesKeMi {
	...
	public CoeficientesKeMi() {
		
	}

	public CoeficientesKeMi(Double caso, Double lambda, Double miX, Double miY, Double miX1, Double miY1, Double kx,
