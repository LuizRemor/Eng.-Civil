...
public class ImpressoesTeste {
	...
	public static void main(String[] args) {
		...
		/*calc.setCoeficientes();
		System.out.println("MiX = "   + calc.coef.getMiX() +
						   " MiY = "  + calc.coef.getMiY() +
						   " MiX1 = " + calc.coef.getMiX1() +
						   " MiY1 = " + calc.coef.getMiY1() +
						   " KX = "   + calc.coef.getKx() +
						   " KY = "   + calc.coef.getKy() +
						   " KX1 = "  + calc.coef.getKx1() +
						   " KY1 = "  + calc.coef.getKy1() );*/
	}
